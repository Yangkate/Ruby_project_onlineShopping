...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { Store_id: @promotion.Store_id, description: @promotion.description, end_date: @promotion.end_date, start_date: @promotion.start_date, title: @promotion.title }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { Store_id: @promotion.Store_id, description: @promotion.description, end_date: @promotion.end_date, start_date: @promotion.start_date, title: @promotion.title }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
